...
<body>
	<div class="main-container">
		<form action="addStock" method="post">
			<h1 style="color: black; text-align: center;">Add Stock</h1>
    		...
    		<input type="text" placeholder="Enter Invoice No" name="invoiceNo" required>
			...
			<hr>
				...
				%>
					...
					<c:forEach items="${list}" var="object">
					 <tr>
						<td>${object.getStockId()}</td>
						<td>${object.getVendorName()}</td>
						<td>${object.getStockInvoice()}</td>
						<td>${object.getDate()}</td>
						<% 		
						if( user.getUserType().equals("Admin")){
							%>
							<td><a href="deleteStock/${object.stockId}" style="text-decoration: none; color: #6D149A;">Delete</a></td>
							<%
						}else{
							%>
							<td style="display: none;"><a href="deleteStock/${object.stockId}" style="text-decoration: none; color: #6D149A;">Delete</a></td>
							<%
						}
